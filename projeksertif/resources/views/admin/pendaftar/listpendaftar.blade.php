...
<div class="mb-5">
    <a href="{{ route('admin.pendaftar.create') }}" class="btn btn-primary">Tambah Data</a>
</div>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-warning btn-sm m-1"
                    href="{{ route('admin.pendaftar.edit', ['id' => $value->id_calon_mahasiswa]) }}">
                    <i class="bx bx-edit"></i> Edit
                </a>

                <!-- Form for deletion -->
                <form action="{{ route('admin.pendaftar.delete.proses', ['id' => $value->id_calon_mahasiswa]) }}"
