...
<form id="pendaftarForm" action="{{ route('camaba.pendaftar.create.proses') }}" method="POST"
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control" id="nama_user" name="nama_user" value="{{ $currentUserName }}"
                readonly>
        </div>
        <div class="col-md-6 mb-3">
