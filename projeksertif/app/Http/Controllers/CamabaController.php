...
class CamabaController extends Controller
{
    public function listPendaftarShow(Request $request)
    {
        ...
        // Mengambil data dari tabel calon mahasiswa yang sesuai dengan nama pengguna yang login
        $dataSiswaMaster = MCamaba::where('nama_user', $userName)->get();

        // Mengirim data ke view
        return view('camaba.pendaftar.listpendaftar', ['dataSiswaMaster' => $dataSiswaMaster]);
    }
    ...
    public function pendaftarShowCreate(Request $request)
    {
        ...
        $user = Auth::guard('pengguna')->user();
        $currentUserName = $user ? $user->nama_user : '';

        return view('camaba.pendaftar.create', compact('provinsiOptions', 'kabupatenOptions', 'currentUserName'));
    }
    ...
    public function pendaftarProsesAdd(Request $request)
    {
        ...
        return redirect()->route('camaba.pendaftar.listpendaftar');
    }
    ...
    public function pendaftarShowEdit(Request $request, $id)
    {
        ...
        return view('camaba.pendaftar.edit', compact('dataSiswa', 'provinsiOptions', 'kabupatenOptions'));
    }
